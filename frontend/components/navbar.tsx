                ...
                {authenticatedNavigation.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white px-3 py-2 text-base font-medium transition-colors flex items-center space-x-2"
