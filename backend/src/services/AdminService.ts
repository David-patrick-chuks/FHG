...
export class AdminService {
  ...
  public static async getGeneralAdminActivityStats(days: number = 7): Promise<ApiResponse<{
    totalActions: number;
    ...
    try {
      const stats = await AdminActionModel.getGeneralAdminActivityStats(days);
      ...
      AdminService.logger.error('Error retrieving general admin activity stats:', error);
      throw error;
    }
  }
